...
from util.GDANet_util_uno import local_operator_withnorm, local_operator, GDM, SGCAM
...
class GDANet(nn.Module):
    ...
    def forward(self, x, norm_plt, cls_label):
        ...
        B, C, N = x.size()
        # print(x.size())
        # print("cccccccccccccccccccccc : ",C)
        # print("Bbbbbbbbbbbbbbbbbbbbbbbbbbb : ",B)
        # print("nnnnnnnnnnnnnnnnnnnnnnnnnN : ",N)
        # ###############
        # """block 1"""
        # print("normal!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!", norm_plt.shape)
